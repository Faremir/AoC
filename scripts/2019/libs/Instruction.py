class Instruction:
    ...
    def set_operations(self):
        ...
        self.ops = {
            k: self.ops[k] for k in (self.ops.keys() & self.computer.instructions)
        }

    def get_params_count(self):
        params_count = {1: 3, 2: 3, 3: 1, 4: 1, 5: 2, 6: 2, 7: 3, 8: 3}
        self.params_count = (
            params_count[self.op_code] if self.op_code in params_count else 0
        )
    ...
    def __addi__(self, in_a, in_b, out_c):
        self.computer.memory[out_c] = (
            self.computer.memory[in_a] + self.computer.memory[in_b]
        )
